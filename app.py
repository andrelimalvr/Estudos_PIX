...
def main():
    ...
    <div style="background-color:white;padding=30px">
        ...
        st.subheader("André Lima")
        
        st.markdown('#### https://www.linkedin.com/in/andrelimalvr/')
